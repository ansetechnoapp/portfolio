import { c as createAstro, a as createComponent, f as renderComponent, e as renderScript, d as renderTemplate, m as maybeRenderHead, b as addAttribute, u as unescapeHTML, F as Fragment, h as renderHead, r as renderSlot } from './astro/server_De9sfnmM.mjs';
import 'kleur/colors';
...
const profile = "Développeur Web & Mobile titulaire d'une licence en systèmes informatiques et logiciels. Passionné par l'innovation technologique, il cherche à mettre ses compétences techniques au service de projets concrets pour contribuer à la croissance des entreprises.";
const dataUser = {
  firstName,
  lastName,
  email,
...
export { $$Layout as $, Icon as I, $$ThemeToggle as a, dataUser as d };
