...
async function main() {
  ...
  const importantImages = new Set([
    '/assets/Anscod_logo/Anscod_logo_dark.png',
    '/assets/Anscod_logo/Anscod_logo_dark_mode.png',
    '/assets/Anscod_logo/Anscod_logo_light_mode.png',
    '/assets/favicon.svg'
  ]);
